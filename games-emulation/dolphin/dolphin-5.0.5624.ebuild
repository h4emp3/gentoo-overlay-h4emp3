...
EGIT_COMMIT="d790660b598a4d9b5d9a2dadd1a375beb83a8788"
KEYWORDS="~amd64"
...
src_prepare() {
	...
	# - glslang: no ebuild
	# - pugixml: dont' know
	# - cpp-optparse: no ebuild
	# - soundtouch: upstream version uses floats instead of shorts
	# - cubeb: no ebuild
